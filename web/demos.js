...
window.RUSH_DEMOS = {
  ...
  mnist: {
    ...
    // MNIST has its own derived thumbnail tree (mirrors the genai scheme).
    // Generated by: scripts/build_thumbnails.py --demo mnist
    thumbnailsDir: 'data/images/mnist-classification/derived/thumbnails',
