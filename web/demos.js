...
window.RUSH_DEMOS = {
  ...
  mnist: {
    ...
    sectionCopy: {
      ...
      labelSub: 'Default: k=20 MNIST digits per split from both training and holdout splits, scored against SME digit truth.',
      labelStartButton: 'Start k=20 per-split run',
      labelDefaultBatch: 'k=20 per split · train + holdout',
