...
The **Run summary** view (topbar) drills into any run → cycle k → evaluation: every image with each judge's full response (label, confidence, difficulty, justification, policy citations), ranked misaligned-first.
